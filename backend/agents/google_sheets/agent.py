...
class SheetsAgent(BaseAgent):
    name: str = "SheetsAgent"
    description: str = "A Google Sheets expert that can handle complex tasks, extract data, map fields, format grids, and build sheets natively."
