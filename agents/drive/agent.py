...
from shared.llm_models import LLM_LITE, LLM_FLASH, LLM_PRO
...
class DriveAgent(BaseDriveAgent):
    ...
    def _get_tools(self):
        ...
        search_and_retrieval_agent = SearchAndRetrievalAgent(self.drive_service, LLM_LITE, self.config, self.print_steps)
