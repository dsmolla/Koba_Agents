        ...
        <>
            ...
            >
                ...
                <div className={`p-6 flex items-center justify-between ${isCollapsed ? 'md:justify-center' : ''}`}>
                    ...
                    {/* Mobile Close Button */}
                    <button onClick={onClose} className="md:hidden text-primary-400 hover:text-primary-300 transition-colors">
                        <X size={20} />
                    </button>
                </div>
                ...
                <div className="p-4 border-t border-dark-border flex flex-col gap-2">
                    ...
                    >
                        ...
                        <div className={`text-left overflow-hidden ${isCollapsed ? 'md:hidden' : ''}`}>
                            <p className="text-sm font-medium truncate text-primary-100">
                                {user?.user_metadata?.full_name || user?.email?.split('@')[0]}
                            </p>
                            <p className={`text-xs truncate ${activeTab === 'settings' ? 'text-primary-300' : 'text-primary-400/60'}`}>
