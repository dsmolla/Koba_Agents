...
class SearchFilesTool(BaseTool):
    ...
    def _run(
        ...
        try:
            builder = self.drive_service.query()
...
class DownloadFileTool(BaseTool):
    ...
    def _run(self, file_id: str) -> ToolResponse:
        try:
            file = self.drive_service.get(file_id)
            ...
            downloaded_path = self.drive_service.download_file(file, download_folder)
...
class ListFolderContentsTool(BaseTool):
    ...
    def _run(
        ...
        try:
            folder = self.drive_service.get(folder_id)
            ...
            contents = self.drive_service.list_folder_contents(
                folder=folder,
...
class GetPermissionsTool(BaseTool):
    ...
    def _run(self, file_id: str) -> ToolResponse:
        try:
            item = self.drive_service.get(file_id)
            permissions = self.drive_service.get_permissions(item)
